...
sshpass -p $variable1 autossh admin@192.168.15.204 " echo $1 | ipa user-add $2 --first=$3 --last=$4 --email=$5 --password-expiration="2027-05-05T20:34:08Z" --homedir="/home/$2" --password"
...
sshpass -p $1 autossh -o StrictHostKeyChecking=no $2@192.168.15.201 "mkdir /stage/$2"
...
sshpass -p $variable1 autossh -o StrictHostKeyChecking=no admin@192.168.15.204 "ipa user-mod $2 --sshpubkey='$ip1key'"
sshpass -p $variable1 autossh -o StrictHostKeyChecking=no admin@192.168.15.204 "ipa user-mod $2 --sshpubkey='$ip2key'"
sshpass -p $variable1 autossh -o StrictHostKeyChecking=no admin@192.168.15.204 "ipa user-mod $2 --sshpubkey='$ip3key'"
